...
export const Experience = ({ register }: ExperienceInterface) => {
        ...
        <Form>
          <Form.Group controlId="linkedin" className="mb-4">
            ...
            <Form.Text className="text-muted mb-2">
              How many years of experience directly relevant to the position do
              you have?
            </Form.Text>
            <select
          ...
          <Form.Group controlId="expertSkills" className="mb-4">
            ...
            <Form.Text className="text-muted mb-2">
              Which of the following list do you consider yourself an expert in?
            </Form.Text>
            <div className="form-check">
              <input
                className="form-check-input"
          ...
          <Form.Group controlId="familiarSkills" className="mb-4">
            <Form.Label>
              <span className="green-bullet"></span>Are you familiar (but not an
              expert) with these skills?
