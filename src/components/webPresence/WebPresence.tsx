...
export const WebPresence = ({ register }: WebPresenceInterface) => {
  ...
  return (
    <Container className="information-container">
      ...
      <div className="presence-information-container">
        <Form>
          ...
          <Form.Group controlId="references" className="mb-4">
            ...
            <Form.Text className="text-muted mb-2">
              Do you have any references that you would like to share? Mentions
              to your work, articles, or any other relevant references you would
              like to share? Feel free to enter one url per line.
            </Form.Text>
            <Form.Control
              type="text"
              required
